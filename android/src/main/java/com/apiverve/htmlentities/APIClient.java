package com.apiverve.htmlentities;
...
/**
 * Main API client for HTML Entities Encoder/Decoder
 * Provides a simple interface to access the APIVerve HTML Entities Encoder/Decoder
 */
public class HTMLEntitiesEncoder/DecoderAPIClient {
     ...
     */
    public HTMLEntitiesEncoder/DecoderAPIClient(String apiKey) {
