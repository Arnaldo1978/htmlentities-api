# HTML Entities Encoder/Decoder API - Examples

This folder contains example code for using the HTML Entities Encoder/Decoder API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/htmlentities',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/htmlentities");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/htmlentities](https://docs.apiverve.com/ref/htmlentities)
